...
export const pushUpdatesForDraftableExtensions = async ({ stderr, stdout, abortSignal: signal }, { extensions, developerPlatformClient, apiKey, remoteExtensionIds: remoteExtensions, proxyUrl, localApp: app }) => {
    ...
    await Promise.all(extensions.map(async (extension) => {
        ...
        return setupExtensionWatcher({
            ...
            onChange: async () => {
                ...
                return performActionWithRetryAfterRecovery(async () => updateExtensionDraft({ extension, developerPlatformClient, apiKey, registrationId, stdout, stderr }), refreshToken);
            },
        });
    }));
};
export async function setupDraftableExtensionsProcess({ localApp, apiKey, developerPlatformClient, remoteApp, ...options }) {
