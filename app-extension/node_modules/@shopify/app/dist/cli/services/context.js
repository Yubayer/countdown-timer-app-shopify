...
import { renderConfirmationPrompt, renderInfo, renderTasks } from '@shopify/cli-kit/node/ui';
...
export async function ensureDevContext(options, developerPlatformClient) {
    ...
    selectedApp = {
        ...selectedApp,
        configuration: await fetchAppRemoteConfiguration(selectedApp.apiKey, developerPlatformClient, specifications, selectedApp.betas),
    };
...
const appFromId = async (appId, developerPlatformClient) => {
...
async function ensureIncludeConfigOnDeploy({ org, app, partnersApp, reset, force, }) {
...
async function fetchOrgsAppsAndStores(orgId, developerPlatformClient) {
    let data = {};
    const tasks = [
        {
 ...
 */
async function selectOrg(developerPlatformClient) {
