...
export default async function link(options, shouldRenderSuccess = true) {
    ...
    const remoteAppConfiguration = await fetchAppRemoteConfiguration(remoteApp.apiKey, developerPlatformClient, localApp.specifications ?? [], localApp.remoteBetaFlags);
...
async function loadLocalApp(options, remoteApp, directory) {
...
async function loadRemoteApp(localApp, apiKey, developerPlatformClient, directory) {
    if (!apiKey) {
