...
export function testDeveloperPlatformClient(stubs = {}) {
    return {
        ...
        appFromId: (_clientId) => Promise.resolve(testOrganizationApp()),
        ...
        specifications: (_appId) => Promise.resolve([]),
        ...
        appExtensionRegistrations: (_appId) => Promise.resolve(emptyAppExtensionRegistrations),
        activeAppVersion: (_appId) => Promise.resolve(emptyAppVersion),
        functionUploadUrl: () => Promise.resolve(functionUploadUrlResponse),
        updateExtension: (input) => Promise.resolve(extensionUpdateResponse),
        deploy: (input) => Promise.resolve(deployResponse),
        generateSignedUploadUrl: (input) => Promise.resolve(generateSignedUploadUrlResponse),
        ...stubs,
    };
}
